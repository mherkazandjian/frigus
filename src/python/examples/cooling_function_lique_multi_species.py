...
nc_h_rng = [
               1.e2, 1.e3, 1.e4, 1.e5, 1.e6, 1.e7, 1.e8, 1.e9, 1.e10, 1.e11, 1.e12, 1.e13, 1.e14
           ] * u.meter ** -3
...
for nc_index, nc_h in enumerate(nc_h_rng):
    ...
    axs.set_xlabel('T$_\mathrm{kin}$ [K]', fontsize=26)
    axs.set_ylabel('cooling function [erg $\cdot$ s$^{-1}$]', fontsize=26)
