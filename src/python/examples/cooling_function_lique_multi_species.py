...
species_data_h2_h_zero_a = DataLoader().load('H2_lique')
species_data_h2_h_zero_a.a_matrix *= 0.0
species_data_h2_h_zero_a.raw_data.a *= 0.0
species_data_h2_h_zero_a.raw_data.a_info_nnz = list(species_data_h2_h_zero_a.raw_data.a_info_nnz)
species_data_h2_h_zero_a.raw_data.a_info_nnz[4] *= 0.0


species_data_h2_he = DataLoader().load('HeH2')
#species_data_wrathmall = DataLoader().load('H2_wrathmall')

x = compute_transition_rate_matrix(species_data_h2_h,
                                   5000.*u.Kelvin,
                                   0.0*u.Kelvin,
                                   1.e6* u.meter ** -3)

m_without_a = compute_transition_rate_matrix(species_data_h2_h_zero_a,
                                   5000.*u.Kelvin,
                                   0.0*u.Kelvin,
                                   1.e6* u.meter ** -3)
