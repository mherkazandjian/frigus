...
class DataSetHDGalileoProject(DataSetBase):
    """
    Data of HD colliding with H using collisional data use by Desrousseaux and Coppola (first paper - limited energy).
...
class DataSetHDDesrousseaux(DataSetBase):
    """
    Data of HD colliding with H using collisional data use by Benjamin Desrousseaux and Coppola (full dataset).

      - energy levels of HD from Amaral 2019
      - collisional coefficients of HD with H (K_ij)
      - radiative coefficients (A_ij, B_ij, B_ji) from Amaral 2019
    ...
    def __init__(self):
        ...
        Constructor
        """
        super(DataSetHDDesrousseaux, self).__init__()
        self.read_raw_data()
        self.reduce_raw_data()
    ...
    def read_raw_data(self):
        ...
        # read the einstein coefficients for the HD transitions
        #
        a, a_info_nnz = read_einstein_coefficient.read_einstein_amaral()
        self.raw_data.a = a
        self.raw_data.a_info_nnz = a_info_nnz
...
class DataLoader(object):
    ...
    def __init__(self):
        ...
        self.availabe_datasets = {
            ...
            'HeH2': DataSetHeH2,
            'HD_desrousseaux': DataSetHDDesrousseaux
        }
